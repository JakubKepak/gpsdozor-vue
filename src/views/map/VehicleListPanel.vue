...
<template>
  ...
  <div
    v-else
    class="absolute top-4 left-4 z-10 flex flex-col bg-white rounded-xl shadow-2xl overflow-hidden"
    :style="{ width: '320px', maxHeight: 'calc(100% - 32px)', border: '1px solid rgba(0,0,0,0.08)' }"
  >
    <!-- Header -->
